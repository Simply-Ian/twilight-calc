...
/// @brief Математическая модель приложения.
/// @details Хранит MFP, словарь всех доступных операторов и функций, словарь доступных переменных; оборачивает функции модуля expression
/// и пользуется ими для вычисления выражений
